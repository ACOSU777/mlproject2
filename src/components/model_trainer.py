...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            logging.info("Spliting Training & Input data into X & Y Sets")
            ...
            ## To get tje best model name from dict
            ...
            if best_model_score <0.6:
                raise CustomException("So far the best model's performance is not good enough...")
